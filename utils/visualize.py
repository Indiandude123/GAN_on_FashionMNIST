...
def save_generated_images(epoch, generator, fixed_noise, results_dir="results"):
    """
    ...
    with torch.no_grad(): # No need to compute gradients for visualization
        ...
        # Rescale from [-1, 1] to [0, 1] for proper display/saving if generator output is Tanh
